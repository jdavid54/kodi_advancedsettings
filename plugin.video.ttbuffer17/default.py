...
fanart = xbmc.translatePath(os.path.join('special://home/addons/plugin.program.ttbuffer17', 'fanart.jpg'))
iconart = xbmc.translatePath(os.path.join('special://home/addons/plugin.program.ttbuffer17', 'icon.png'))
SETTINGS_PATH = os.path.join(xbmc.translatePath('special://profile/addon_data/plugin.program.ttbuffer17'), 'settings.xml')
...
def MENU(name):
    ...
    addDirPlayable("Write XML File to temporary location", 'url',500, '','Play it safe. Write your advanced settings to userdata/plugin.program.ttbuffer17/XML_FILES/ directory',editfile,'')
